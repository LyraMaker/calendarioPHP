...
<body>
    ...
    <footer class="p-4 has-text-white is-flex is-justify-content-center has-background-black">
        <div class="container has-text-centered"><p>Site desenvolvido por <em>Gabriel Lyra Torquato</em></p></div>
        <div class="container has-text-centered"><p>Página gerada às <?php echo date('H').':'.date('i'); ?></p></div>
    </footer>
